  ...
  <div class="container">
      ...
      <div class="row">
          <div class="col-sm-10 col-sm-offset-1 text-center text-slice-section-text-area">
              $Content
              <iframe width="840" height="616" src="https://www.youtube.com/embed/$VideoURL?autoplay=$VideoAutoPlay&start=$VideoStart&disablekb=$DisableKeyboardCtrl" frameborder="0" allowfullscreen></iframe>
              <%if $VideoURL2 %>
